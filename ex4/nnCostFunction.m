...
% Prepare y values as vectors with corresponding ones
I = eye(num_labels);
...
sigma2 = sigma2(:, 2:end); % without bias element which is always +1

% Accumulate gradients
delta_1 = (sigma2' * a1);
delta_2 = (sigma3' * a2);

% Calculate regularized gradient usign backpropagation
